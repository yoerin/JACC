<?php
/**
 * @version		$Id: category.php 193 2014-06-30 08:34:25Z michel $
 * @package		##Component##
 * @subpackage	models
...
class ##Component##ModelCategory extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		    ...
		    $format = $app->input->getWord('format', null);
		    if ($format=='feed') {
			    $limit = $config->get('feed_limit');
		    }
		    else {
			    $limit = $app->getUserStateFromRequest('global.list.limit', 'limit', $config->get('list_limit'));
		    }
