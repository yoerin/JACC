...
##ifdefFieldorderingStart##
		if ($this->##primary## === 0) {
			//get next ordering
<?php if($this->category_field): ?>
			$condition = ' <?php echo $this->category_field; ?> = '.(int) $this-><?php echo $this->category_field; ?> <?php if($this->publishedField): ?> . ' AND <?php echo $this->publishedField; ?> >= 0 '; <?php endif; ?>
<?php endif; ?>

			$this->ordering = $this->getNextOrder(<?php if($this->category_field): ?> $condition <?php endif; ?>);
